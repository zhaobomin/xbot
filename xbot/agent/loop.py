...
from xbot.agent.skills import BUILTIN_SKILLS_DIR
...
if TYPE_CHECKING:
    from xbot.config.schema import ChannelsConfig, ExecToolConfig, WebSearchConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        web_tools_config: Any | None = None,
        ...
        from xbot.config.schema import ExecToolConfig, WebSearchConfig
        ...
        self.web_tools_config = web_tools_config
    ...
    def _register_default_tools(self) -> None:
        ...
        self.tools.register(WebFetchTool(proxy=self.web_proxy, web_config=self.web_tools_config))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from xbot.agent.tools.mcp import connect_mcp_servers
        try:
    ...
    async def _handle_restart(self, msg: InboundMessage) -> None:
        ...
        async def _do_restart():
            ...
            # Use -m xbot instead of sys.argv[0] for Windows compatibility
            # (sys.argv[0] may be just "xbot" without full path on Windows)
