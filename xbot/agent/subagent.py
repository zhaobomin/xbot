...
from xbot.config.schema import ExecToolConfig, WebToolsConfig
from xbot.providers.base import LLMProvider
from xbot.utils.helpers import build_assistant_message
...
class SubagentManager:
    ...
    def __init__(
        ...
        from xbot.config.schema import ExecToolConfig, WebSearchConfig, WebToolsConfig
        ...
        self.web_tools_config = web_tools_config or WebToolsConfig()
    ...
    async def spawn(
        ...
        origin_session_key = session_key or f"{origin_channel}:{origin_chat_id}"
        origin = {
    ...
    async def _run_subagent(
        ...
        try:
            ...
            tools.register(WebFetchTool(proxy=self.web_proxy, web_config=self.web_tools_config))
