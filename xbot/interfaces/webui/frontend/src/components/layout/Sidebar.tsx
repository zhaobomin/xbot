      ...
      <div className={cn(
        ...
        {!collapsed && (
          <div className="flex h-9 items-center">
            <span className="text-[2rem] font-black lowercase tracking-[-0.08em] bg-gradient-to-r from-orange-400 via-orange-500 to-amber-700 bg-clip-text text-transparent">
              xbot
            </span>
          </div>
        )}
        {collapsed && (
          <div className="flex h-9 w-9 items-center justify-center rounded-xl border border-orange-500/20 bg-orange-500/10">
            <span className="text-sm font-black lowercase text-orange-400">x</span>
          </div>
        )}
        <button
          onClick={onToggle}
          ...
          className={cn(
            ...
            collapsed && "opacity-100 absolute right-2"
          )}
        >
          {collapsed
