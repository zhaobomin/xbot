...
def _make_loop():
    ...
    with patch("xbot.agent.loop.ContextBuilder"), \
         patch("xbot.agent.loop.SessionManager"), \
         patch("xbot.agent.loop.SubagentManager") as MockSubMgr:
...
class TestSubagentCancellation:
    ...
    async def test_subagent_preserves_reasoning_fields_in_tool_turn(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("xbot.agent.tools.registry.ToolRegistry.execute", fake_execute)
